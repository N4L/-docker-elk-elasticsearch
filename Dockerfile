...
FROM docker.elastic.co/elasticsearch/${IMAGE_ARG_ES_IMAGE_NAME:-elasticsearch}:${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2} as base
...
#/usr/share/elasticsearch/bin/elasticsearch-plugin install --batch https://artifacts.elastic.co/downloads/elasticsearch-plugins/ingest-geoip/ingest-geoip-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}.zip
# come with docker image
#/usr/share/elasticsearch/bin/elasticsearch-plugin install --batch https://artifacts.elastic.co/downloads/elasticsearch-plugins/ingest-user-agent/ingest-user-agent-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}.zip
RUN set -ex \
  && cd /usr/share/elasticsearch \
  && bin/elasticsearch-plugin install --batch https://artifacts.elastic.co/downloads/elasticsearch-plugins/analysis-icu/analysis-icu-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}.zip \
  ...
  && bin/elasticsearch-plugin install --batch https://artifacts.elastic.co/downloads/elasticsearch-plugins/discovery-ec2/discovery-ec2-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}.zip \
...
RUN set -ex \
  && curl -L -O https://artifacts.elastic.co/downloads/beats/metricbeat/metricbeat-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}-x86_64.rpm \
  && rpm -iv metricbeat-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}-x86_64.rpm \
  ...
  && rm -f metricbeat-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}-x86_64.rpm

RUN set -ex \
  && curl -L -O https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}-x86_64.rpm \
  && rpm -vi filebeat-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}-x86_64.rpm \
  ...
  && rm -f filebeat-${IMAGE_ARG_ES_IMAGE_VERSION:-7.5.2}-x86_64.rpm
